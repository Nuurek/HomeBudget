# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-13 12:20
...
class Migration(migrations.Migration):
    ...
    replaces = [('home_budget', '0002_auto_20170209_0015'), ('home_budget', '0003_auto_20170213_1305'), ('home_budget', '0004_auto_20170213_1314')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='PLN', max_digits=8)),
                ('amount', models.DecimalField(decimal_places=3, default=1, max_digits=16)),
                ('product_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='home_budget.ProductCategory')),
            ],
        ),
        migrations.CreateModel(
            name='Receipt',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home_budget.Brand')),
            ],
        ),
        migrations.AddField(
            model_name='receipt',
            name='shop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='home_budget.Shop'),
        ),
        migrations.AddField(
            model_name='purchase',
            name='receipt',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home_budget.Receipt'),
        ),
